...
# Generation Time: 2024-04-25 20:17:19 +0000
# ************************************************************
...
CREATE TABLE `courses` (
  ...
  `status_id` enum('1','3','5','6') NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
...
VALUES
	...
	(6,'UI/UX',10000,120,'2024-01-05','2024-03-05',NULL,7,'6','2024-04-24 18:30:28','2024-04-25 21:32:19');
...
CREATE TABLE `students` (
  ...
  `status_id` enum('1','2','3','4','5','7','8') NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
...
VALUES
	(3,'John Andrew','Hurley','1996-03-25','johnhurley@johnhurley.com','+351000000000','Avenue of John Hurley','2024-04-23',5,NULL,NULL,'1','2024-04-24 14:49:09','2024-04-25 21:39:16'),
	...
	(20,'Adrian','Holden','1980-02-12','adrian8156@aol.net','1-388-134-2370','P.O. Box 751, 213 Ante St.','2022-06-01',5,NULL,NULL,'7','2024-04-24 18:35:11','2024-04-25 21:39:33'),
	(21,'Anjolie','Fuentes','1987-07-08','anjolie@yahoo.ca','1-834-265-4853','724-6666 In Street','2021-05-10',6,NULL,NULL,'8','2024-04-24 18:35:11','2024-04-25 21:39:38'),
...
CREATE TABLE `teachers` (
  ...
  `status_id` enum('1','2','3','6','7') NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
VALUES
	...
	(8,'Aline','Nash','1959-02-22','aline@hotmail.net','1-580-777-6426','946-1014 Integer St.','2024-12-07','6','2024-04-24 17:30:22','2024-04-25 21:41:43'),
	(9,'Cedric','Castillo','1984-05-11','cedric@hotmail.edu','1-336-281-9153','Ap #579-6849 Augue Rd.','2021-10-22','7','2024-04-24 17:30:22','2024-04-25 21:41:43'),
